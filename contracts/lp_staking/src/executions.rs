...
use staking::lp_staking::execute_msgs::ExecuteMsg;
use staking::message_factories;
use staking::utils::make_response;
...
//CONTRACT: the executor must increase allowance of token first before executing auto stake
pub fn auto_stake(
    deps: DepsMut,
    env: Env,
    info: MessageInfo,
